...
func AddRoutes(e *echo.Echo, h *handlers.Handler) {
	...
	InstrumentationAgentDefinitionRoutes(e, h)
	InstrumentationAgentInstanceRoutes(e, h)
	InstrumentationBrowserRelayDefinitionRoutes(e, h)
	InstrumentationBrowserRelayInstanceRoutes(e, h)
	InstrumentationGatewayDefinitionRoutes(e, h)
	InstrumentationGatewayInstanceRoutes(e, h)
	KubernetesRuntimeDefinitionRoutes(e, h)
	KubernetesRuntimeInstanceRoutes(e, h)
	KubernetesWorkloadDefinitionRoutes(e, h)
	KubernetesWorkloadInstanceRoutes(e, h)
	KubernetesWorkloadResourceDefinitionRoutes(e, h)
	KubernetesWorkloadResourceInstanceRoutes(e, h)
	...
	MachineRuntimeDefinitionRoutes(e, h)
	MachineRuntimeInstanceRoutes(e, h)
	MachineWorkloadDefinitionRoutes(e, h)
	...
	OciOkeKubernetesRuntimeDefinitionRoutes(e, h)
	OciOkeKubernetesRuntimeInstanceRoutes(e, h)
	OciProviderRoutes(e, h)
	ProfileRoutes(e, h)
	...
	TierRoutes(e, h)
	TracingDefinitionRoutes(e, h)
	TracingInstanceRoutes(e, h)
}
